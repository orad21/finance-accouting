...
class PageTransition {
        ...
        navButtons.forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                if (targetPage === 'index.html') {
                    this.navigateToDashboard(targetPage, pageName);
                } else {
                    this.navigateToPage(targetPage, pageName);
                }
            });
        });
        ...
        document.addEventListener('click', (e) => {
            ...
            if (link && (link.href.includes('index.html') || 
                ...
                if (href.includes('index.html')) {
                    this.navigateToDashboard(href, pageName);
                } else {
                    this.navigateToPage(href, pageName);
                }
            }
        });
    }
    ...
    async navigateToDashboard(url, pageName) {
